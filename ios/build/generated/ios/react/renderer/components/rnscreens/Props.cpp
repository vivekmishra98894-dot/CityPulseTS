...
folly::dynamic RNSSplitViewHostProps::getDiffProps(
  ...
  if (displayMode != oldProps->displayMode) {
    result["displayMode"] = toDynamic(displayMode);
  }
    
  if (splitBehavior != oldProps->splitBehavior) {
    result["splitBehavior"] = toDynamic(splitBehavior);
  }
